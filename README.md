...
>  **These get only generated if you rename a text layer in Illustrator to a name of your liking.** This option generates a JavaScript file that includes the text content of named text layers in JavaScript code for scripting purpouses (like in Hype Data Magic or Hype Action Events etc.).
